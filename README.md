...
- the residualization code
- the PCA versus RMT comparison
- the long/short portfolio construction logic
- transaction-cost and regime diagnostics
- committed figures, CSV results, and notes
- a real-stock extension on a public large-cap panel

The project is not trying to prove a production trading strategy from GitHub.
It is trying to show the research question clearly and test it in a way that is
easy to inspect.

## Core Idea

In a cross-sectional stat-arb strategy, the signal often comes from residual
mean reversion. That means:
...
- it gives a runnable version of the method
- it preserves the summary of the original historical project
...
This repo is best read as a clean research project on:

- covariance denoising
- PCA versus RMT residualization
- residual mean reversion
- neutral long/short portfolio construction
- backtesting under trading costs

It is not a live trading claim. It is a careful study of whether better
residual extraction helps the downstream signal.
