...
The benchmark in this repo is a structured reproducible panel, not the original
...
The benchmark in this repo makes the central research point inspectable: spectral denoising changes the quality of the residual sleeve materially once the portfolio is forced to stay beta-controlled and cost-aware.

## Important Limitation

This benchmark in this repo is a stylized residual-denoising experiment, not proof of
a live deployable stat-arb edge. Cost sensitivity is material, and production
execution issues are not fully modeled here.

## Original Project

The saved original Georgia Tech project summary is in:
...
- [original_project_evidence/saved_cv_project_excerpt.md](original_project_evidence/saved_cv_project_excerpt.md)
